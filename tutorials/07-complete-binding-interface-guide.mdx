...
ctrl.poll_feedback_once()  # Manual feedback poll (optional in current releases)
```
...
| v0.3.3 and later | Background polling enabled by default; `poll_feedback_once()` is optional |
