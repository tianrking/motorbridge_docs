...
| RobStride | `ping`, `robstride-read-param`, `robstride-write-param` | 29-bit extended-frame parameter path; runtime parameters use the common section 4 table (`0x7005..0x702E`) |
