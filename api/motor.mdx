...
Ping a RobStride motor using an explicit host-side ID. This is the v0.3.3 scan-safe path used when probing multiple possible `feedback_id` / `host_id` values.
