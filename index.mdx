...
<Badge variant="primary">v0.2.7</Badge> <Badge variant="secondary">Python 3.10+</Badge>
...
<Cards>
  ...
  <Card title="RobStride Parameters" icon="table" href="reference/robstride-parameter-tables">
    RS00-RS06 protocol notes and model-specific parameter tables
  </Card>
</Cards>
...
<AccordionGroup>
  ...
  <Accordion title="Reference">
    ...
    - [RobStride Parameter Tables](reference/robstride-parameter-tables) - Communication protocol summary plus independent RS00-RS06 parameter tables
  </Accordion>
