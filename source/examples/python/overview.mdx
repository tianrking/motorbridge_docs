...
The examples use `rs-06` only as a sample model. Replace it with the physical RS00-RS06 model before real interaction because RobStride parameter IDs and types are model-specific.
