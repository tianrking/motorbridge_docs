...
**相关文档：** [CLI 参考](reference.mdx) | [shared/channel-compat.md](../../shared/channel-compat.md)
...
| 参数 | 类型 | 默认值 | 说明 |
|---|---|---|---|
| `--set-motor-id` | u16 可选 | 无 | 新设备 ID，范围 1..255 |
| `--store` | `0/1` | `1` | 保存参数 |
...
- `--set-motor-id` / Python CLI `--new-motor-id` 会校验为 `1..255`；超范围值会直接报错，不会被截断。
- 该路径下扩展 ID 组成为：
