...
| 组件 | 源文件 | 当前版本 |
|------|--------|----------|
| Git 发布标签 | `motorbridge` 仓库 | `v0.3.3` |
| Python 包 | `bindings/python/pyproject.toml` | `0.3.3` |
| Rust workspace crates | `Cargo.toml` 的 `[workspace.package]` | `0.3.3` |
...
| 0.3.3 | 3.10 | SocketCAN / PCAN | 版本查询、CLI 写参 `--store 1`、RobStride 保存 ACK 对齐 |
