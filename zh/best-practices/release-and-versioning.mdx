...
| 组件 | 源文件 | 当前版本 |
|------|--------|----------|
| Git 发布标签 | `motorbridge` 仓库 | `v0.2.8` |
| Python 包 | `bindings/python/pyproject.toml` | `0.2.8` |
| Rust workspace crates | `Cargo.toml` 的 `[workspace.package]` | `0.2.8` |
