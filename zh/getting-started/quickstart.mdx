...
- Python API 参考：[sdk/python/reference.mdx](../sdk/python/reference.mdx)
- CLI 全参数文档：[cli/reference.mdx](../cli/reference.mdx)
- 架构说明：[architecture/overview.mdx](../architecture/overview.mdx)
