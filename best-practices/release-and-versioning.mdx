...
|-----------|-------------|-----------------|
| Planned Git release tag | `motorbridge` repository | `v0.4.0` |
| Python package | `bindings/python/pyproject.toml` | `0.4.0` |
| Rust workspace crates | `Cargo.toml` `[workspace.package]` | `0.4.0` |
...
|----------|---------|-----------|
| Stable | `0.4.0` | Production ready |
| Pre-release | `0.4.0a1` | Testing only |
| Development | `0.4.0.dev1` | Internal use |
...
# Upgrade to latest stable: 0.4.0
pip install --upgrade motorbridge
